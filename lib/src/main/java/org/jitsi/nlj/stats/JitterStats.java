...
public class JitterStats
{
    ...
    public void addPacket(Instant currentPacketSentTimestamp, Instant currentPacketReceivedTimestamp)
    {
    ...
    public static double calculateJitter(
        double currentJitter,
        Instant previousPacketSentTimestamp,
        Instant previousPacketReceivedTimestamp,
        Instant currentPacketSentTimestamp,
        Instant currentPacketReceivedTimestamp)
    {
        /*
        ...
        Duration delta = Duration.between(previousPacketSentTimestamp, previousPacketReceivedTimestamp)
            .minus(Duration.between(currentPacketSentTimestamp, currentPacketReceivedTimestamp));
         ...
         * sampled.
         */
        return currentJitter + (Math.abs(delta.toMillis()) - currentJitter) / 16.0;
    }
}

...
public enum RtpExtensionType
{
     ...
     * Defined at
     * {@code http://www.webrtc.org/experiments/rtp-hdrext/abs-send-time}
     */
     ...
     * {@code https://tools.ietf.org/html/draft-ietf-avtext-framemarking-03}
     */
     ...
     * in {@code https://tools.ietf.org/html/draft-ietf-perc-double-02}.
     */
     ...
     * in {@code https://tools.ietf.org/html/draft-ietf-mmusic-rid-10}.
     */
     ...
     * in {@code https://tools.ietf.org/html/rfc5450}.
     */
    ...
    private static final Map<String, RtpExtensionType> uriMap = new HashMap<>();

    static
    {
        for (RtpExtensionType type : values())
        {
            uriMap.put(type.uri, type);
        }
    }

    public static RtpExtensionType createFromUri(String uri)
    {

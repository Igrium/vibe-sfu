 ...
 */
public class TransportLossReport
{
    public final Instant receiveTime;
    public final Instant startTime;
    public final Instant endTime;
    public final long packetsLostDelta;
    public final long packetsReceivedDelta;

    public TransportLossReport(
        Instant receiveTime, Instant startTime, Instant endTime, long packetsLostDelta, long packetsReceivedDelta)
    {

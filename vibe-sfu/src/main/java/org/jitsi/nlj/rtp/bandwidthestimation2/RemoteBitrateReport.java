 ...
 */
public class RemoteBitrateReport
{
    public final Instant receiveTime;
    public final Bandwidth bandwidth;

    public RemoteBitrateReport(Instant receiveTime, Bandwidth bandwidth)
    {
        this.receiveTime = receiveTime;
        this.bandwidth = bandwidth;
    }

    public RemoteBitrateReport()
    {
        this(Instant.MAX, Bandwidth.INFINITY);
    }
}

 ...
 */
public class SingleRtcpParser extends PacketParser
{
    public SingleRtcpParser(Logger parentLogger)
    {
        super("Single RTCP parser", parentLogger, packet -> RtcpPacket.parse(packet.buffer, packet.offset, packet.length));
    }

...
class OveruseDetector
{
    ...
    // (Library change: OveruseDetectorConfig is a plain Java holder here, not a Kotlin
    // companion object, so this is a direct static field reference.)
    private static final double overusingTimeThreshold = OveruseDetectorConfig.overusingTimeThreshold;

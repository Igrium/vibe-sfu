...
public class RemoteBitrateEstimatorAbsSendTime
{
        ...
        int payloadSize)
    {
        ...
        // (Library change: upstream's `payloadSize.bytes` was a Kotlin extension property
        // generated into DataSizeKt by a different DataSize type; this library's DataSize
        // uses a plain static factory instead.)
        incomingBitrate.update(DataSize.ofBytes(payloadSize), arrivalTimeMs);
